...
export default function KapcsolatPage() {
  ...
  return (
    <>
      ...
      {/* Compact header */}
      <section className="max-w-[1300px] mx-auto px-4 md:px-10 pt-9 pb-8 border-b border-[#e6e4df]">
      ...
      <section className="max-w-[1300px] mx-auto px-4 md:px-10 py-10 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div>
            {sent ? (
              <div className="flex flex-col items-center justify-center text-center py-20 border border-[#e6e4df] rounded-2xl bg-[#fafaf8]">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input required type="text" placeholder="Kovács Anna"
                      className="w-full px-4 py-3 text-sm border border-[#e6e4df] rounded-xl bg-[#fafaf8] text-[#111] placeholder-[#ccc] focus:outline-none focus:border-[#1a3a2a] transition-colors" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea required rows={6} placeholder="Meséld el, mire van szükséged..."
                    className="w-full px-4 py-3 text-sm border border-[#e6e4df] rounded-xl bg-[#fafaf8] text-[#111] placeholder-[#ccc] focus:outline-none focus:border-[#1a3a2a] transition-colors resize-none" />
                </div>
                <button type="submit"
                  className="w-full bg-[#1a3a2a] text-white text-sm font-semibold py-3.5 rounded-full tracking-wide hover:bg-[#2d4a2d] transition-colors duration-200">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-[#e6e4df] h-52">
              <iframe
